...
def _worker_prompt(context: str) -> str:
    ...
    return (
        ...
        "`FACTORY_RESULT: done <one-line summary>` on success, or "
        "`FACTORY_RESULT: blocked <one-line reason>` when blocked. "
        "Do not omit this line.\n"
    )


def factory_spawn(task, workspace: str, *, board=None) -> int | None:
...
__all__ = ["factory_spawn", "reap_finished"]
