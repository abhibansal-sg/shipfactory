...
rendering uses the host's real `Button`, `Badge`, `Card`, and `CardContent`
modules; tabs, drawer behavior, state badges, and layout are the real bundle.
