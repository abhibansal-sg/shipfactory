...
exec /Users/abbhinnav/Developer/products/hermes-mobile/.venv/bin/python -m shipfactory.cli daemon --board factory-shakedown5 >> ~/.hermes/shipfactory/runs/daemon.log 2>&1
